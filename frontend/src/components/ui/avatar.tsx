    ...
    return (
        <AvatarPrimitive.Root
            ...
            className={cn(
                ...
                // Only apply these if no custom width/height is provided in className
                !className?.includes("size-") && !className?.includes("w-") && [
                    "size-8",
    ...
    return (
        <AvatarPrimitive.Fallback
            ...
            className={cn(
                ...
                // Scale text based on parent size
                "group-data-[size=sm]/avatar:text-xs",
                "group-data-[size=default]/avatar:text-sm",
                "group-data-[size=lg]/avatar:text-base",
                "group-data-[size=xl]/avatar:text-4xl", // Large initials for profile page
                className
            )}
            {...props}
        />
