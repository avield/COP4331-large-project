...
export default function SidebarButton({ Icon, to, children }: { Icon: React.ElementType, to?: string, children: React.ReactNode}) {
  ...
  return <>
    <Button variant={"ghost"} className='justify-start gap-3 px-3 py-5 duration-150 transition-colors text-base font-normal hover:text-white! cursor-pointer' size={"lg"} asChild>
